...
Feature: Reporting service
    Scenario: Manager requests list of payments
        ...
        When a payment event with amount "10" is received from ID "111" to "222" and correlation id "1"
        And a payment event with amount "20" is received from ID "111" to "222" and correlation id "2"
        And a payment event with amount "30" is received from ID "111" to "222" and correlation id "3"
    ...
    Scenario: Customer requests list of payments
        ...
        When a payment event with amount "10" is received from ID "111" to "333" and correlation id "1"
        And a payment event with amount "20" is received from ID "111" to "444" and correlation id "2"
        And a payment event with amount "30" is received from ID "222" to "444" and correlation id "3"
        And a payment event with amount "30" is received from ID "111" to "333" and correlation id "4"
        And a payment event with amount "20" is received from ID "222" to "333" and correlation id "5"
